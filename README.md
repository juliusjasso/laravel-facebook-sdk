...
[![Build Status](https://img.shields.io/travis/moomak/LaravelFacebookSdk.svg)](https://travis-ci.org/moomak/LaravelFacebookSdk)
[![Latest Stable Version](https://img.shields.io/packagist/v/moomak/laravel-facebook-sdk.svg?maxAge=2592000)](https://packagist.org/packages/moomak/laravel-facebook-sdk)
[![Total Downloads](https://img.shields.io/packagist/dt/moomak/laravel-facebook-sdk.svg)](https://packagist.org/packages/moomak/laravel-facebook-sdk)
[![License](https://img.shields.io/badge/license-MIT-lightgrey.svg)](https://github.com/moomak/LaravelFacebookSdk/blob/master/LICENSE)


A fully unit-tested package for easily integrating the [Facebook SDK v5](https://developers.facebook.com/docs/php/gettingstarted/5.0.0) into Laravel 9.
...
This example also demonstrates how to [exchange a short-lived access token with a long-lived access token](https://www.moomak.me/access-token-handling-best-practices-in-facebook-php-sdk-v4) and save the user to your `users` table if the entry doesn't exist.
...
Please see [CONTRIBUTING](https://github.com/moomak/LaravelFacebookSdk/blob/master/CONTRIBUTING.md) for details.


## Credits

This package is maintained by [Scott Bowler](https://github.com/moomak). See a [full list of contributors](https://github.com/moomak/laravel-facebook-sdk/contributors).


## License

The MIT License (MIT). Please see [License File](https://github.com/moomak/LaravelFacebookSdk/blob/master/LICENSE) for more information.
